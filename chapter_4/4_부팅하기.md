...
- 한가지 이상한 점은 책에서는 CortexA8 프로세서를 이용하는데, 해당 프로세서의 스펙에는 익셉션 백터가 나와있지 않고, 다른 버전인 ARM11에 나와 있다는 점이다.
...
~~~
- C로 제작된 코드이지만, GCC로 컴파일 시 entry.S 어셈블리어 파일에서도 호출이
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUxMTQ0ODg4NiwtMTA1ODgzNDY0OSwtNz
czNTU3MDA4LDc0NDI4NDA5NiwtMTQxOTI2NjQyNSwxNTAzNTY1
ODkwXX0=
-->