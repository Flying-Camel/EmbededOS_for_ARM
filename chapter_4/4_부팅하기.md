...
- ``$(CC) -march=$(ARCH) -mcpu=$(MCPU) -I $(INC_DIRS) -g -o $@  $<``
	...
	- 또 실행 파일이 아니라 오브젝트 파일을 만들어야 하므로 
- 위의 코드를 추가해 주면 된다.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMDUyNjE3ODksLTE3MTUwMzg5NDgsLT
E3NTA5MTQ4NjcsMjc4MzM0NjIsLTk3NzM4NDQ1NywxOTIwODE3
ODA5LC0xMDU4ODM0NjQ5LC03NzM1NTcwMDgsNzQ0Mjg0MDk2LC
0xNDE5MjY2NDI1LDE1MDM1NjU4OTBdfQ==
-->